...
export interface Coordinates { latitude: number; longitude: number; accuracy?: number; source?: 'device' | 'manual'; }
export interface RankedDsa { feature: DsaFeature; distanceMetres: number; bearingDegrees: number; direction: string; }
